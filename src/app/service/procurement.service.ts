...
export interface PurchaseOrder {
  ...
  totalAmount: number;
  itemsCount: number;
  status: 'Draft' | 'Pending' | 'Approved' | 'Closed' | 'Cancelled';
}
...
export class ProcurementService {
  ...
  private purchaseOrders: PurchaseOrder[] = [
    ...
    { id: 4, poNumber: 'PO-2026-0004', supplierName: 'Pacifc Chemical Corp', orderDate: '2026-06-25', deliveryDate: '2026-07-10', totalAmount: 12400.00, itemsCount: 80, status: 'Draft' },
