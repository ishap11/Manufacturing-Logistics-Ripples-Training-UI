...
export class SupplierService {
  ...
  private rateCards: RateCard[] = [
    { id: 1, supplierName: 'ABC Industries', origin: 'Chicago (ORD)', destination: 'Dallas (DFW)', mode: 'Road', ratePerKg: 1.25, transitDays: 2, effectiveDate: '2026-01-01' },
    { id: 2, supplierName: 'XYZ Electronics', origin: 'Mumbai (BOM)', destination: 'Los Angeles (LAX)', mode: 'Air', ratePerKg: 4.80, transitDays: 4, effectiveDate: '2026-02-15' },
    { id: 3, supplierName: 'Global Packaging', origin: 'London (LHR)', destination: 'New York (JFK)', mode: 'Sea', ratePerKg: 0.65, transitDays: 14, effectiveDate: '2026-03-01' },
    { id: 4, supplierName: 'Pacific Chemical', origin: 'Tokyo (NRT)', destination: 'San Francisco (SFO)', mode: 'Air', ratePerKg: 5.20, transitDays: 3, effectiveDate: '2026-01-10' },
    { id: 5, supplierName: 'Apex Logistics', origin: 'Frankfurt (FRA)', destination: 'Chicago (ORD)', mode: 'Sea', ratePerKg: 0.85, transitDays: 18, effectiveDate: '2026-04-01' }
  ];
  ...
  updateSupplier(id: number, updatedData: Partial<Supplier>): Observable<Supplier | null> {
